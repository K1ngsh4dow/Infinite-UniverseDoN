                ...
                <div className="lg:col-span-1 space-y-6 flex flex-col">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            ...
                            <div className={`h-3 w-3 rounded-full ${isMarketOpen && isOnline ? 'bg-green-500 animate-pulse' : 'bg-red-500'}`}></div>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                <TableHeader>
                     ...
                     <Card className="flex-grow flex flex-col">
                        ...
                        <CardContent className="flex-grow">
                            <ScrollArea className="h-64">
                                ...
                                {news.length === 0 && <p className="text-muted-foreground text-sm">No recent market news.</p>}
                                {news.map((item, index) => (
